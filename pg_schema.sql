...
ALTER TYPE public.mpaa_rating OWNER TO daeunyim;
...
ALTER DOMAIN public.year OWNER TO daeunyim;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO daeunyim;
...
ALTER FUNCTION public.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO daeunyim;
...
ALTER FUNCTION public.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO daeunyim;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp with time zone) OWNER TO daeunyim;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO daeunyim;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO daeunyim;
...
ALTER FUNCTION public.last_day(timestamp with time zone) OWNER TO daeunyim;
...
ALTER FUNCTION public.last_updated() OWNER TO daeunyim;
...
ALTER TABLE public.customer_customer_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.customer OWNER TO daeunyim;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO daeunyim;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO daeunyim;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.actor OWNER TO daeunyim;
...
ALTER TABLE public.category_category_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.category OWNER TO daeunyim;
...
ALTER TABLE public.film_film_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.film OWNER TO daeunyim;
...
ALTER TABLE public.film_actor OWNER TO daeunyim;
...
ALTER TABLE public.film_category OWNER TO daeunyim;
...
ALTER TABLE public.actor_info OWNER TO daeunyim;
...
ALTER TABLE public.address_address_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.address OWNER TO daeunyim;
...
ALTER TABLE public.city_city_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.city OWNER TO daeunyim;
...
ALTER TABLE public.country_country_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.country OWNER TO daeunyim;
...
ALTER TABLE public.customer_list OWNER TO daeunyim;
...
ALTER TABLE public.film_list OWNER TO daeunyim;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.inventory OWNER TO daeunyim;
...
ALTER TABLE public.language_language_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.language OWNER TO daeunyim;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO daeunyim;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.payment OWNER TO daeunyim;
...
ALTER TABLE public.payment_p2020_01 OWNER TO daeunyim;
...
ALTER TABLE public.payment_p2020_02 OWNER TO daeunyim;
...
ALTER TABLE public.payment_p2020_03 OWNER TO daeunyim;
...
ALTER TABLE public.payment_p2020_04 OWNER TO daeunyim;
...
ALTER TABLE public.payment_p2020_05 OWNER TO daeunyim;
...
ALTER TABLE public.payment_p2020_06 OWNER TO daeunyim;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.rental OWNER TO daeunyim;
...
ALTER TABLE public.sales_by_film_category OWNER TO daeunyim;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.staff OWNER TO daeunyim;
...
ALTER TABLE public.store_store_id_seq OWNER TO daeunyim;
...
ALTER TABLE public.store OWNER TO daeunyim;
...
ALTER TABLE public.sales_by_store OWNER TO daeunyim;
...
ALTER TABLE public.staff_list OWNER TO daeunyim;
